workspace "iv-console-select-menu"
	configurations { "ReleaseIV", "DebugIV" }
	location "project_files"
   
project "iv-console-select-menu"
	kind "SharedLib"
	language "C++"
	...
	filter { "configurations:*IV" }
		...
		targetname "ConsoleSelectMenuIV"
		debugdir "$(GTA_IV_DIR)"
		debugcommand "$(GTA_IV_DIR)/GTAIV.exe"
		postbuildcommands "copy /y \"$(TargetPath)\" \"$(GTA_IV_DIR)\\plugins\\ConsoleSelectMenuIV.asi\""
